...
## Висновок
Отже, відштовхуючись від проведених дослідів, визначимося з методами
оптимізації Dockerfile, а також тим, як їх варто застосовувати.

Правильне застосування шарів може значно скоротити час збірки знімків. На
практиці це виглядає як винесення найбільш незмінних етапів збірки на початок
Dockerfile, накшталт встановлення залежностей.

Важливо також зважати на те, як знімок буде використовуватися. Якщо він буде
лише тримати сервер, на якому не потрібно нічого робити, то мінімального
зображення як-от `distroless` буде більш ніж достатньо.

Крім того, у випадку застосування компільованих мов варто не забувати про
багатоетапові збірки, які можуть багатократно зменшити розмір знімків, хоча
також варто відзначити безпекові переваги даного підходу у поєднанні з мінімальними знімками.
